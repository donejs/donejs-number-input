# Contributing to donejs-number-input

## Developing Locally

This section will walk you through setting up the [repository](https://github.com/donejs/donejs-number-input) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork donejs-number-input, you can start by going to its [fork page](https://github.com/donejs/donejs-number-input/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/donejs-number-input
```
